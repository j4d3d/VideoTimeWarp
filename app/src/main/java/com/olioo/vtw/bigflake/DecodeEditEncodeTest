...
/**
 * This file is identical to the one on Bigflake save for some IOException catches and the package name
 * android.test.AndroidTestCase has been replaced by my own baby AndroidTestCase class for simplicity
 *
